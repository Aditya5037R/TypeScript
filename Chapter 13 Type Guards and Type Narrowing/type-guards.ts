...
function displayPerson(person: StudentInfo | TeacherInfo): void {
    if ("course" in person) {
...
function isStudent(person: StudentInfo | TeacherInfo): person is StudentInfo {
    return "course" in person;
}

function identifyPerson(person: StudentInfo | TeacherInfo): void {
    if (isStudent(person)) {
...
function displayUser(user: User): void {
    switch (user.role) {
        ...
        case "student":
            console.log(
                `${user.name} is a student of ${user.course}.`
            );
            break;

        case "teacher":
            console.log(
                `${user.name} teaches ${user.subject}.`
            );
            break;
    }
}
